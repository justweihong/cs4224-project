...
./cassandra-loader -f ./project_files/data_files/customer.csv -schema "supplier_db.customers(c_w_id, c_d_id, c_id, c_first, c_middle, c_last, c_street_1, c_street_2, c_city, c_state, c_zip, c_phone, c_since, c_credit, c_credit_limit, c_discount, c_balance, c_ytd_payment, c_payment_cnt, c_delivery_cnt, c_data)" -configFile ./ycql/setup/loaderConfig -batchSize 100 -dateFormat "yyyy-MM-dd HH:mm:ss.SSS" -nullString "null"
